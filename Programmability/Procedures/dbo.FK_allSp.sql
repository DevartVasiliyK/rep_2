...
/* $Header: /ApplicationDB/Stored Procedures/FK_allSp.sp 2     6/17/03 12:03p Matagl $  */
/*
...
AS
   ...
   GO'
   FROM sysreferences
   WHERE object_name(rkeyid) like '%[_]all%'
